...
public class BinaryConsole {
    private static String ReturnIndent(int indent){
        return " ".repeat(Math.max(0, indent));
    }

    public static String ConsoleOutput(PulseBinary pulseConfig) throws Exception {
        var stringBuilder = new StringBuilder(String.format("==========[%s / PULSE BINARY]==========\n{\n", pulseConfig.documentID()));
