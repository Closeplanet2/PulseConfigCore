...
public class ConfigDeSerializer {
    ...
    private static ArrayList<Object> LoadConfig(List<Object> storedData) throws Exception {
    ...
    private static Object LoadConfig(Object data, Object configObject) throws Exception {
        ...
        else if(data instanceof List) return LoadConfig((List<Object>) configObject);
